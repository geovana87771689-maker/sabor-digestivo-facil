  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Se ha producido un error. Puedes volver a intentarlo o regresar al inicio.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sabor & Balance" },
      { name: "description", content: "Recetas en porciones pequeñas con proteína real y preparación sencilla." },
      { name: "author", content: "Sabor & Balance" },
