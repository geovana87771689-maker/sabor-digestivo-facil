...
const tiers: Tier[] = [
  {
    ...
    subtitle: "Almuerzos ligeros, recetas exprés y lista de compra de 7 días.",
    highlight: "Beneficio clave: alivio digestivo desde la primera semana",
    features: [
      "1 semana de almuerzos ligeros planificados",
      "Recetas exprés anti-náusea para el almuerzo",
  ...
  },
  {
    ...
    subtitle:
      "100 recetas completas (desayuno, almuerzo y cena), snacks, postres y menú de 35 días.",
    highlight: "Beneficio clave: ahorras 20,00 € (pagas 17,99 € en vez de 37,99 €) + acceso vitalicio",
    features: [
      "100 recetas completas (desayuno, almuerzo y cena), snacks, postres y menú de 35 días.",
  ...
  },
  {
    ...
    oldPrice: "29,99 €",
    note: "Pago único · 50% OFF",
    subtitle: "Menú planificado día a día para 14 días (comida y cena) + guía digestiva.",
    highlight: "Beneficio clave: menú de 14 días (comida y cena) + guía digestiva",
    features: [
      "Menú planificado día a día para 14 días (almuerzo y cena)",
      "Almuerzos y cenas ligeros, listos en 15 minutos",
