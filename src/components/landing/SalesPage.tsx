...
const bonificaciones = [
  { label: "BONUS 1", img: bonus1PostresAsset.url, title: "50 POSTRES PROTEICOS SIN AZÚCAR", text: "Algo dulce que suma proteína en vez de restarla. Para la hora en la que siempre se rompe el plan." },
