...
const bonificaciones = [
  { label: "BONUS 1", img: "/bonus-1-mockup.png", title: "20 postres proteicos sin azúcar", text: "Algo dulce que suma proteína en vez de restarla. Para la hora en la que siempre se rompe el plan.", value: "9,90 €" },
  { label: "BONUS 2", img: "/bonus-2-mockup.png", title: "20 snacks de bolsillo", text: "Pequeños, transportables y con proteína de verdad. Para los días de oficina y los huecos entre comidas.", value: "9,90 €" },
  { label: "BONUS 3", img: "/bonus-3-mockup.png", title: "Planificador semanal", text: "Qué desayunas, comes y cenas cada día, ya decidido. Se imprime y se pega en la nevera.", value: "7,90 €" },
  { label: "BONUS 4", img: "/bonus-4-mockup.png", title: "Listas de la compra con sustituciones", text: "Organizadas por semana y con equivalencias de supermercado español.", value: "7,90 €" },
  { label: "BONUS 5", img: "/bonus-5-mockup.png", title: "Guía de macros e hidratación", text: "Cuánta proteína necesitas al día y cómo repartirla.", value: "5,90 €" },
];
